...
create table public.homepage_content (
  ...
  hero_card_street text not null default 'Hehlentorstraße 8',
  hero_card_city text not null default '29221 Celle',
  hero_card_hours text not null default 'Montag bis Freitag 09:00 - 19:00, Samstag 09:00 - 16:00',
  hero_stat_location text not null default 'Celle Zentrum',
  hero_stat_style text not null default 'Luxury Grooming',
