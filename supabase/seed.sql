...
on conflict (id) do update set
  ...
  hero_card_city = excluded.hero_card_city,
  hero_card_hours = excluded.hero_card_hours,
  hero_stat_location = excluded.hero_stat_location,
  hero_stat_style = excluded.hero_stat_style,
  footer_rights = excluded.footer_rights,
  contact_section_eyebrow = excluded.contact_section_eyebrow,
  contact_section_title = excluded.contact_section_title,
  contact_section_subtitle = excluded.contact_section_subtitle,
